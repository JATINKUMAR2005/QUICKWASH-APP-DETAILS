...
class EthnicWearScreen extends StatefulWidget {
  const EthnicWearScreen({super.key});

  @override
  State<EthnicWearScreen> createState() => _EthnicWearScreenState();
}

class _EthnicWearScreenState extends State<EthnicWearScreen> {
  ...
  void initState() {
    ...
    for (final cartItem in cart) {
      if (cartItem['category'] == 'Ethnic Wear' && _quantities.containsKey(cartItem['item'])) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(addedCount > 0 
              ? 'Added $addedCount Ethnic items to order!' 
              : 'Ethnic items updated.'),
                    ...
                    Container(
                      ...
                      child: const Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8),
                          Text(
                            'Expert handling for delicate fabrics',
                            style: TextStyle(
                              fontSize: 18,
