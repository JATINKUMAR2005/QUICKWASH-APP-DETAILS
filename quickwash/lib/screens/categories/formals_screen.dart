...
class FormalsScreen extends StatefulWidget {
  const FormalsScreen({super.key});

  @override
  State<FormalsScreen> createState() => _FormalsScreenState();
}

class _FormalsScreenState extends State<FormalsScreen> {
  ...
  final Map<String, List<String>> _itemServices = {
    'Suit/Blazer': ['Dry Clean'],
    'Formal Shirt': ['Dry Clean'],
    'Formal Trousers': ['Dry Clean'],
    'Tie/Accessory': ['Dry Clean'],
  };
  ...
  void initState() {
    ...
    for (final cartItem in cart) {
      if (cartItem['category'] == 'Formals' && _quantities.containsKey(cartItem['item'])) {
  ...
  void _updateItem(String item, int qty, List<String> services) async {
    ...
    await appState.addToCart(
      ...
      emoji: emoji,
      quantity: qty,
      services: services.isNotEmpty ? services : ['Dry Clean'],
      basePrice: price,
    );
  }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(addedCount > 0 
              ? 'Added $addedCount Formals to order!' 
              : 'Formals items updated.'),
                    ...
                    Container(
                      ...
                      child: const Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8),
                          Text(
                            'Crease-free hanger packaging & premium conditioning',
                            style: TextStyle(
                              fontSize: 18,
