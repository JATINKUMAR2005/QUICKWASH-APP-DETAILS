...
class BottomsCategoryScreen extends StatefulWidget {
  const BottomsCategoryScreen({super.key});

  @override
  State<BottomsCategoryScreen> createState() => _BottomsCategoryScreenState();
}

class _BottomsCategoryScreenState extends State<BottomsCategoryScreen> {
  ...
  void initState() {
    ...
    for (final cartItem in cart) {
      if (cartItem['category'] == 'Bottoms' && _quantities.containsKey(cartItem['item'])) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(addedCount > 0 
              ? 'Added $addedCount Bottoms to order!' 
              : 'Bottoms items updated.'),
                    ...
                    Container(
                      ...
                      child: const Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8),
                          Text(
                            'Custom services for each of your bottoms',
                            style: TextStyle(
                              fontSize: 18,
